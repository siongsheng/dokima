...
## Generated: 2026-07-07 02:26:39 (incremental | 110 files)
...
- tests/test_f041_modules.py  — Exports: TestCodebaseMapModule, TestControlPanelModule
...
### Documentation
- ADVERSARIAL_REVIEW.md  — Adversarial Review Report — Dokima Codebase
...
### Other
- codebase_map.py  — Exports: _classify_domain
- control_panel.py  — Exports: handle_status
...
- control_panel.py → imports from status, utils; external: glob
- git_ops.py → imports from utils
...
- tests/test_git_ops.py → imports from conftest, git_ops, utils; external: pytest
...
- utils.py → imports from codebase_map, control_panel, git_ops, spec_extract, vcs; external: importlib, select, shutil
