...
- **F030: CLI redesign: replace --add/--next/--fix/--status/--stop/--kill/--list-crons/--version/--upgrade/--release with proper subcommands (dokima add, dokima next, etc). Flags (--force-full, --max-parallel) keep -- prefix. Update all tests, scripts, AGENTS.md, roadmap, and docs.** — in progress since 2026-07-03 18:55, branch `feat/f030-cli-redesign-replace---add--next--f-4a6b860c` [panel]
