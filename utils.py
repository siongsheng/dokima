...
CONTROL:
  ...
  dokima --release [patch|minor|major] [--dry-run] [project_dir]  Bump version, generate changelog, tag, and publish GitHub Release. bump types: patch (bug fixes), minor (new features), major (breaking changes)
