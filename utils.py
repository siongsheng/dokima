...
"""
import sys, json, subprocess, os, pwd, time, shlex, re, fcntl, signal, datetime, importlib, select
...
# HELP_TEXT moved to control_panel.py — imported below
# CLI_METADATA moved to control_panel.py — imported below
...
# show_help moved to control_panel.py — imported below
# show_help_json moved to control_panel.py — imported below
# check_upgrade moved to control_panel.py — imported below
# _version_newer moved to control_panel.py — imported below
...
def update_status_md(status_path: str, feature_id: str, title: str, status: str,
    ...
    with open(status_path, "w") as f:
        f.write(output)
# _check_pid moved to control_panel.py — imported below
# _verify_pid_owner moved to control_panel.py — imported below
# _get_lock_state moved to control_panel.py — imported below
