...
CLI_METADATA = {
    ...
    "version": VERSION,
    "commands": [
        {"name": "run", "syntax": "dokima \"Feature description\" [dir]", "description": "Run full pipeline for a feature", "subcommand": True},
        {"name": "init", "syntax": "dokima init \"description\" [dir]", "description": "Project discovery & constitution", "subcommand": True},
        {"name": "add", "syntax": "dokima add \"Feature\" [--priority=P1] [dir]", "description": "Add feature to roadmap (auto-priority, auto-deps)", "subcommand": True},
        {"name": "next", "syntax": "dokima next [dir]", "description": "Build next feature from roadmap", "subcommand": True},
        {"name": "continuous", "syntax": "dokima continuous [dir]", "description": "Full sprint: build + auto-merge + loop", "subcommand": True},
        {"name": "fix", "syntax": "dokima fix [dir]", "description": "Fix BLOCKED PR: detect blockers, fix, verify", "subcommand": True},
        {"name": "status", "syntax": "dokima status [dir]", "description": "Show pipeline state", "subcommand": True},
        {"name": "stop", "syntax": "dokima stop [dir]", "description": "Graceful stop after current feature", "subcommand": True},
        {"name": "kill", "syntax": "dokima kill [dir]", "description": "Emergency kill (SIGTERM then SIGKILL)", "subcommand": True},
        {"name": "list-crons", "syntax": "dokima list-crons", "description": "List all scheduled pipelines", "subcommand": True},
        {"name": "version", "syntax": "dokima version", "description": "Print version and exit", "subcommand": True},
        {"name": "upgrade", "syntax": "dokima upgrade", "description": "Check for newer version and show upgrade instructions", "subcommand": True},
        {"name": "release", "syntax": "dokima release <patch|minor|major> [--dry-run] [project_dir]", "description": "Bump version, generate changelog, tag, and publish GitHub Release", "subcommand": True},
        {"name": "map", "syntax": "dokima map [dir]", "description": "Generate codebase-map.md", "subcommand": True},
        {"name": "help", "syntax": "dokima help [--json]", "description": "Show help text (--json for machine-readable output)", "subcommand": True},
    ],
    "flags": [
