...
# ── F041: Map functions extracted to codebase_map.py ──
from codebase_map import (load_map_enrichments, save_map_enrichments,
                          extract_map_enrichments, generate_codebase_map,
