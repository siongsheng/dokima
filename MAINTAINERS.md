...
### Phase 1: Strategist (`run_phase1_strategist`, line 2676, decomposed into ~15 helpers by F043)
...
### Phase 2: Coder (`run_phase2_coder`, line 721, decomposed by F043)
...
### Phase 3: Vet (`run_phase3_vet`, line 1001)
...
### Phase 4: nm / Adversarial Review (`run_phase4_nm`, line 1599)
...
### Phase 5: Tech Lead (`run_phase5_tech_lead`, line 1743)
...
| `specs/.map-enrichments.json` | Accumulated agent guidance from strategist > MAP: markers |
