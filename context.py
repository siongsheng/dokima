"""PipelineContext dataclass — replaces 20+ module-level globals.

A single PipelineContext dataclass passed to each phase function.
Eliminates the conftest __setattr__ override hack.
...
class PipelineContext:
    ...
    def __post_init__(self):
        ...
        if self.project_dir and not os.path.isdir(self.project_dir):
            # Non-fatal: allow test contexts with fake paths
            pass
