...
def test_fix_mode_skips_auto_archive(panel, tmpdir):
    """fix subcommand should skip auto-archive block."""
    import subprocess
...
def test_fix_answers_warning(panel):
    """fix subcommand + --answers should warn and ignore answers file."""
...
# ═══════════════════════════════════════════════════════════════════
# Task 8: fix subcommand in help text
# ═══════════════════════════════════════════════════════════════════


def test_help_text_includes_fix(panel):
    """fix subcommand should appear in HELP_TEXT."""
    assert "dokima fix" in panel.HELP_TEXT
