...
class TestReleaseHelpText:
    """Tests that release appears as a subcommand in HELP_TEXT and CLI_METADATA."""
    ...
    def test_help_includes_release_command(self):
        """--help output includes release in subcommands section."""
    ...
    def test_help_json_includes_release(self):
        """--help-json output includes release subcommand entry."""
    ...
    def test_release_invalid_bump_exits_1(self):
        """dokima release invalid exits non-zero with usage error."""
