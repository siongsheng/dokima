...
Task 11: Update AGENTS.md usage references. The F030 CLI redesign replaces standalone
--flags (--add, --next, --fix, --status, --stop, --kill, --list-crons,
--version, --upgrade, --release, --continuous, --map, --map-full, --help,
--help-json) with subcommands (dokima add, dokima next, etc.).
AGENTS.md should not reference the old flag-style invocations.
"""
