"""Codebase map generation — domain-aware project mapping for agent context.

Extracted from utils.py (F041 Task 3).
Generates specs/codebase-map.md with 4 sections: Start Here, Domain Map,
Impact Map, Test Map. Uses file hashes for incremental mode.
"""
import os
import re
import sys
